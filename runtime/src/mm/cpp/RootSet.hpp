...
public:
    ...
    ThreadRootSet(ShadowStack& stack, CurrentException& currentException, ThreadLocalStorage& tls) noexcept : stack_(stack), currentException_(currentException), tls_(tls) {}
